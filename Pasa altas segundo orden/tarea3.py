# -*- coding: utf-8 -*-
"""
Created on Tue Nov 30 21:42:13 2021
...
fs1 = 44100 #puede cambiarse a mas
#periodo de muestre
ts1 =1/fs1
...
numz1 = [(A**2)*wn**2,-2*(wn**2)*A**2,(A**2)*wn**2]
#denominador de la funcion de transferencia en "z"
denz1 = [((A**2)*wn**2)+2*wn*wo1*A+wo1**2,-2*(wn**2)*(A**2)+2*wo1**2,(wn**2)*(A**2)-2*wn*wo1*A+wo1**2]#talves le falta
#respuesta en frecuencia del filtro
...
filt_signal = signal.lfilter(numz1,denz1,raw_signal)
